...
from fenet.models.losses.lineiou_loss import liou_loss
...
class FEHeadV1(nn.Module):
    ...
    def forward(self, x, **kwargs):
        ...
        for stage in range(self.refine_layers):
            ...
            # cls_features [4608,64] = [B*num_priors, fc_hidden]
            # reg_features [4608,64] = [B*num_priors, fc_hidden]
            ...
            # cls_logits [24,192,2] = [batch,num_priors,2]
            cls_logits = cls_logits.reshape(
                batch_size, -1, cls_logits.shape[1])  # (B, num_priors, 2)
            reg = reg.reshape(batch_size, -1, reg.shape[1])
            # reg [24,192,76] = [b,num_priors,76]
