...
import fenet.utils.culane_metric as culane_metric
import cv2
...
class CULane(BaseDataset):
    ...
    def evaluate(self, predictions, output_basedir):
        ...
        # Generate thresholds with np.linspace
        ...
        for item in partial_view_list:
            ...
            for cate, cate_file in CATEGORYS.items():
                ...
                result = culane_metric.eval_predictions(output_basedir,
                                                        ...
                                                        iou_thresholds=rounded_thresholds,
                                                        official=True,partial_view_num=item)
